...
import { Trophy, Search, Star, ArrowLeft } from "lucide-react"
...
export default function RankingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8">
      <header className="max-w-4xl mx-auto flex flex-col md:flex-row md:items-center justify-between border-b border-slate-800 pb-6 mb-8 gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium">
              Veja quem está liderando o bolão corporativo
            </p>
          </div>
        </div>
        ...
        <div className="relative w-full md:w-64">
          ...
          <Input
            ...
            className="pl-9 h-10 rounded-full bg-slate-900 border-slate-800 text-white placeholder-slate-500 text-xs w-full focus-visible:ring-nina-red"
          />
        </div>
      </header>
