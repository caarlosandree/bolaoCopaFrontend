...
// Palpites
export function saveGuess(match_id: number, home_guess: number, away_guess: number) {
...
// Admin: lançar placar
export function updateMatchScore(matchId: number, home_score: number, away_score: number) {
  return request<{ message: string; match_id: number; score: { home: number; away: number } }>(
